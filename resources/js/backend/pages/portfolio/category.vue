                ...
                <div class="col-md-12">
                    <div class="float-left">
                            <button class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" @click="toggleForm">
                                <i class="fas fa-plus fa-sm text-white"></i> Add New Portfolio category
                            </button>
                    </div>
...
export default {
    ...
    methods: {
        getData(page = 1) {
            axios
                .get("/admin/category/portfolio/get-all?page=" + page)
                .then(response => {
        ...
        submitForm() {
            ...
            if (this.formState == "save") {
                axios
                    .post("/admin/category/portfolio/store", formData, config)
                    .then(response => {
        ...
        deleteItem(id) {
            ...
            if (confirm) {
                axios
                    .delete("/admin/category/portfolio/delete/" + id)
                    .then(response => {
