<template>
    <div class="blog col-12 p2">
        ...
        <div class="blog-title col-12 mb-5 ">
            <div class="row">
                <h4 class="pr-2">Service Category</h4>
...
export default {
    ...
    data() {
        return {
            ...
            //listing
            items: [],
            fields: ["SN", "Category", "image", "Action"],
            //show empty message
    ...
    methods: {
        getData(page = 1) {
            axios
                .get("/admin/category/service/get-all?page=" + page)
                .then(response => {
        ...
        submitForm() {
            ...
            if (this.formState == "save") {
                axios
                    .post("/admin/category/service/store", formData, config)
                    .then(response => {
        ...
        deleteItem(id) {
            ...
            if (confirm) {
                axios
                    .delete("/admin/category/service/delete/" + id)
                    .then(response => {
